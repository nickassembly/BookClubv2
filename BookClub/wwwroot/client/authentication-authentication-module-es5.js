...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
  ...
  function srcAppAuthenticationAuthenticationModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AuthenticationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([{
        path: 'register',
  ...
  function srcAppAuthenticationLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(_authService, _router, _route) {
        var _this41 = this;
        ...
        this.validateControl = function (controlName) {
          return _this41.loginForm.controls[controlName].invalid && _this41.loginForm.controls[controlName].touched;
        };

        this.hasError = function (controlName, errorName) {
          return _this41.loginForm.controls[controlName].hasError(errorName);
        };

        this.loginUser = function (loginFormValue) {
          _this41.showError = false;
          var login = Object.assign({}, loginFormValue);
          var userForAuth = {
            username: login.username,
            password: login.password
          };

          _this41._authService.loginUser('api/auth/login', userForAuth).subscribe(function (res) {
            localStorage.setItem("token", res.token);

            _this41._authService.sendAuthStateChangeNotification(res.isAuthSuccessful);

            _this41._router.navigate([_this41._returnUrl]);
          }, function (error) {
            _this41.errorMessage = error;
            _this41.showError = true;
          });
        };
      }
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]));
    };
  ...
  /***/
  function srcAppAuthenticationRegisterUserRegisterUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_custom_validators_password_confirmation_validator_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function RegisterUserComponent(_authService, _passConfValidator, _router) {
        var _this42 = this;
        ...
        this.validateControl = function (controlName) {
          return _this42.registerForm.controls[controlName].invalid && _this42.registerForm.controls[controlName].touched;
        };

        this.hasError = function (controlName, errorName) {
          return _this42.registerForm.controls[controlName].hasError(errorName);
        };

        this.registerUser = function (registerFormValue) {
          _this42.showError = false;
          var formValues = Object.assign({}, registerFormValue);
          var user = {
          ...
          _this42._authService.registerUser("api/accounts/registration", user).subscribe(function (_) {
            _this42._router.navigate(["/authentication/login"]);
          }, function (error) {
            _this42.errorMessage = error;
            _this42.showError = true;
          });
        };
      }
      ...
      _createClass(RegisterUserComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.registerForm.get('confirm').setValidators([_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, this._passConfValidator.validateConfirmPassword(this.registerForm.get('password'))]);
        }
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterUserComponent, [{
        ...
        return [{
          ...
          type: _shared_custom_validators_password_confirmation_validator_service__WEBPACK_IMPORTED_MODULE_3__["PasswordConfirmationValidatorService"]
        }, {
  ...
  /***/
  function srcAppSharedCustomValidatorsPasswordConfirmationValidatorServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PasswordConfirmationValidatorService", function () {
      return PasswordConfirmationValidatorService;
    });
    /* harmony import */
    ...
    var PasswordConfirmationValidatorService = function PasswordConfirmationValidatorService() {
      _classCallCheck(this, PasswordConfirmationValidatorService);

      this.validateConfirmPassword = function (passwordControl) {
        return function (confirmationControl) {
          var confirmValue = confirmationControl.value;
          var passwordValue = passwordControl.value;
    ...
    PasswordConfirmationValidatorService.ɵfac = function PasswordConfirmationValidatorService_Factory(t) {
      return new (t || PasswordConfirmationValidatorService)();
    };

    PasswordConfirmationValidatorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PasswordConfirmationValidatorService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
